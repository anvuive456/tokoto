...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var provider = Provider.of<DetailProductProvider>(context);
  ...
  Widget _buildList(DetailProductProvider provider) {
                  ...
                  trailing: InkWell(
                    ...
                    onTap: () {
                      if(data.isFavourite == true){
                        provider.unLikeProduct(data.id);
                      } else {
                        provider.likeProduct(data.id);
                      }
                    },
                    child: Container(
